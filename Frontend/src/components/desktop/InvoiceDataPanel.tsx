        ...
        {(status === "complete" || status === "error") && data && data.is_invoice && (
          <div className="space-y-6 animate-in">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {/* Total HT */}
              {data.total_ht && (
                <div className="p-4 rounded-xl bg-white border border-slate-100 shadow-sm hover:border-emerald-200 transition-colors group">
                  <div className="flex items-center gap-2.5 mb-2">
                    ...
                    <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Total HT</span>
                  </div>
                  <EditableField
                    value={data.total_ht}
              ...
              {/* Date d'échéance */}
              {data.date_echeance && (
                <div className="p-4 rounded-xl bg-white border border-slate-100 shadow-sm hover:border-amber-200 transition-colors group">
                  <div className="flex items-center gap-2.5 mb-2">
                    ...
                    <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Date échéance</span>
                  </div>
                  <EditableField
              ...
              {/* Mode de paiement */}
              {data.mode_paiement && (
                <div className="p-4 rounded-xl bg-white border border-slate-100 shadow-sm hover:border-cyan-200 transition-colors group">
                  <div className="flex items-center gap-2.5 mb-2">
                    <div className="p-1.5 rounded-lg bg-cyan-50 text-cyan-600 group-hover:bg-cyan-100 group-hover:text-cyan-700 transition-colors">
                      <CreditCard className="h-4 w-4" />
                    </div>
                    <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Mode paiement</span>
                  </div>
                  <EditableField
            ...
            {/* Section Adresses - Fournisseur & Client */}
            {(data.adresse_fournisseur || data.adresse_client || data.client) && (
